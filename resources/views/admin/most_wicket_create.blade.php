...
<div class="bg-sobuj p-7 h-[150vh] w-[71%] absolute lg:left-[27%] lg:top-20 top-12">
    <div class="flex justify-between">
        <h1 class="text-red-600 font-semibold text-xl">Most Wicket / <span class="{{Request::is('admin/most/wicket/create') ? 'text-green-600':'';}}">Create</span></h1>
    ...
    <div class="mt-10">
        <form action="{{route('most.wicket.store')}}" method="POST" class="text-white space-y-2" enctype="multipart/form-data">
            @csrf
           ...
           <div class="grid grid-cols-2 space-x-5">
            ...
            <div class="grid grid-cols-2 space-x-5">
                ...
                <div class="space-y-2">
                    ...
                    <input class="outline-none rounded-md py-1.5 pl-2 bg-black w-full" type="text" name="over" value="{{old('over')}}">
                    @if($errors->has('over'))
            ...
            <div class="grid grid-cols-2 space-x-5">
                    <div class="space-y-2">
                        <label for="">Sr</label>
                        <input class="outline-none rounded-md py-1.5 pl-2 bg-black w-full" type="text" name="wicket" value="{{old('wicket')}}">
            ...
            <div class="grid grid-cols-2 space-x-5">
                    <div class="space-y-2">
                        <label for="">Eco</label>
                        <input class="outline-none rounded-md py-1.5 pl-2 bg-black w-full" type="text" name="eco" value="{{old('eco')}}">
                        @if($errors->has('eco'))
                    ...
                    <div class="space-y-2">
                        ...
                        <input class="outline-none rounded-md py-1.5 pl-2 bg-black w-full" type="text" name="four_w" value="{{old('four_w')}}">
            ...
            <div class="grid grid-cols-2 space-x-5">
                    <div class="space-y-2">
                        ...
                        <input class="outline-none rounded-md py-1.5 pl-2 bg-black w-full" type="text" name="five_w" value="{{old('five_w')}}">
                    ...
                    <div class="space-y-2">
                        <label for="">BBI</label>
                        <input class="outline-none rounded-md py-1.5 pl-2 bg-black w-full" type="text" name="bbi" value="{{old('bbi')}}">
                        @if($errors->has('bbi'))
